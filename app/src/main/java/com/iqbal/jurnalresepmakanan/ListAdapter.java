...
public class resepListAdapter extends RecyclerView.Adapter<resepListAdapter.ResepViewHolder> {
    ...
    public resepListAdapter(Context context, ArrayList<Recipe> resepList) {
    ...
    public void onBindViewHolder(ResepViewHolder holder, int position) {
        Recipe currentRecipe = resepList.get(position);
    ...
    public class ResepViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        final resepListAdapter mAdapter;

        public ResepViewHolder(View itemView, resepListAdapter adapter) {
            super(itemView);
        ...
        public void onClick(View v) {
            ...
            Recipe resep = resepList.get(mPosition);
